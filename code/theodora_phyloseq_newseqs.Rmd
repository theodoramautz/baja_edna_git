...
alpha_time <- alpha_time + theme(legend.position = "right", legend.key.width = unit(fixed_legend_width, "cm"),
                                 plot.margin = unit(c(1, 1, 1, 1), "lines"))
alpha_transp <- alpha_transp + theme(legend.position = "right", legend.key.width = unit(fixed_legend_width, "cm"),
                                     plot.margin = unit(c(1, 1, 1, 1), "lines"))
...
plot_grid(alpha_lat, alpha_hab, alpha_dep, alpha_div, alpha_time, alpha_transp,
...
permanova.v4 <- adonis2(dist ~ lat_group * Habitat * MaxDepth * Transp,
                      ps.perm.data,
                      permutations=999)
permanova.v4
