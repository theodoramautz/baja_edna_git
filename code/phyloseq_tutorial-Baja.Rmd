...
asvs <- read.csv("03.DADA2/Baja_MiFish_ASVs_wide.csv",
                row.names=1)
...
tax <- read.csv ("03.DADA2/Baja_MiFish_taxa_table.csv")
hash <- read.csv("03.DADA2/Baja_MiFish_hash_key.csv")
...
metadata <- read.csv("baja_edna_metadata.csv", row.names=1)
```
